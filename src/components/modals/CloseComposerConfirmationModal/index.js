...
class CloseComposerConfirmation extends React.Component {
  state = {
    isLoading: false,
  };
      ...
      >
        ...
        >
          <Message>
            {message
              ? message
              : 'Are you sure you want to close this window? You will not be able to recover what you wrote already.'}
          </Message>
